...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col">1<br><a href="../Recipes/recipes.php?id=meatballs"><img src="../Images/meatballs.jpg"></a></div>
        <div class="col">2</div>
        <div class="col">3</div>
    </div>
    <div class="row">
        <div class="col">4<br><a href="../Recipes/recipes.php?id=pancakes"><img src="../Images/pancakes.jpg"></a></div>
        <div class="col">5</div>
        <div class="col">6</div>
        <div class="col">7</div>
        <div class="col">8</div>
